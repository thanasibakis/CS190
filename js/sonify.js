...
const LEVEL = 0.1 // For when multiple tones play, let's avoid clipping
const VOWELS = { 'a': 220, 'e': 277.18, 'i': 329.63, 'o': 392, 'u': 493.88 }
...
let play_long_tone = (frequency) => {
    ...
    oscillator.start()
    gain.gain.exponentialRampToValueAtTime(LEVEL, context.currentTime + 0.25)
